  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-hero p-4">
      ...
      <div className="flex items-center gap-3 mb-8 animate-fade-in">
        ...
        <h1 className="text-4xl font-display font-bold text-gradient">BrainForge</h1>
      </div>
        ...
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {isLogin 
              ...
              : 'Join BrainForge and master Data Structures'}
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {/* Tagline */}
      <p className="mt-8 text-muted-foreground text-center max-w-md animate-fade-in">
